...
public class BasicAjaxExampleTestWithWait extends BrowserConfig {
    ...
    @Test(description = "To see if we are on the right url",groups = {"mobile.test"})
    public void urlPage(){
    ...
    @Test(description = "We verify wait methods and if the elements selected are similar on both pages",groups = {"mobile.test"})
...
//        assertEquals(element.getText(),"2","They are not the same ");
    ...
    @Test(description = "Verify the 5 sec button who will redirects to a different page and will come back to main page",groups = {"mobile.test"})
    ...
    @Test(description = "Verify the 2 sec button who will redirects to a different page and will come back to main page",groups = {"mobile.test"})
    ...
    @Test(description = "Verify the refresh button and if the id from the tex is the same with the id from timestamp",groups = {"mobile.test"})
    ...
    @Test(description = "Verify all the buttons and the message after all the buttons was clicked",groups = {"mobile.test"})
