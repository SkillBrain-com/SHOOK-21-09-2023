...
import com.skillbrain.mentor.pages.toolshop.AddToFavoriteAfterLogin;
import com.skillbrain.mentor.pages.toolshop.RegisterAccount;
import com.skillbrain.mentor.utils.BasePage;
import org.testng.annotations.Test;

public class AddToFavoriteAfterLoginTest extends BasePage {

    @Test
    public void addToFavoriteAfterLogin(){
        driver.get("https://practicesoftwaretesting.com/#/auth/login");

        RegisterAccount registerAccount = new RegisterAccount(driver);
        AddToFavoriteAfterLogin addToFavoriteAfterLogin = new AddToFavoriteAfterLogin(driver);
        ...
        addToFavoriteAfterLogin.addItemToFavorite();
        addToFavoriteAfterLogin.itemConfirmation();
    }
